...
MAINTAINER Taras Omelianenko <t.omelianenko@apibest.com>
...
RUN apt-get -y install apache2 php5 php5-mssql
...
ADD docker/freetds.conf /etc/freetds/
ADD docker/locales.conf /etc/freetds/
